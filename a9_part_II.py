...
def get_planet_radius(planet_name: str) -> str:
    ...
    # Allow numbers with commas and/or decimal points (e.g., 66,854 or 3,376.2)
    pattern = r"(Polar radius\s*)(?P<radius>[\d,\.]+)"
    error_text = "Page infobox has no polar radius information"
    match = get_match(infobox_text, pattern, error_text)
    # Remove commas from the result to match the expected test values
...
def get_birth_date(name: str) -> str:
    ...
    # Match ISO date format in the infobox (e.g., 1955-06-08)
